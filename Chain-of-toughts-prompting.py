...
Think step by step before answering the following query. Break down your reasoning process into logical steps before concluding with a final answer.
"""
...
if prompt := st.chat_input("Type your message..."):
    ...
    with st.chat_message("assistant", avatar="🤖"):
        ...
        # Constructing messages with Chain-of-Thought Prompting
        messages_to_send = st.session_state.messages
        messages_to_send.append({"role": "user", "content": chain_of_thought_prompting + " " + prompt})
