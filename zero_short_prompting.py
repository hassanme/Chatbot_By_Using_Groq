...
zero_shot_prompting = """
Answer the following query directly without requiring additional context or examples.
"""
...
if prompt := st.chat_input("Type your message..."):
    ...
    with st.chat_message("assistant", avatar="🤖"):
        ...
        # Constructing messages with Zero-Shot Prompting
        messages_to_send = st.session_state.messages
        messages_to_send.append({"role": "user", "content": zero_shot_prompting + " " + prompt})
